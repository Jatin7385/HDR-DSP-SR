...
imgs = np.load("./Dataset/test/15/testLR.npy").astype(np.float32)
ratios = np.load("./Dataset/test/15/testRatio.npy").astype(np.float32)
...
file_path = './TrainHistory/FNet_time_05-17-02-25-07/'
